...
*StarEngine (Vegas Edition) is a downstream fork of GPLAsync/DXVK. Lead development by isygold. All upstream credit belongs to ishitatsuyuki (GPLAsync) and the DXVK contributors.*
